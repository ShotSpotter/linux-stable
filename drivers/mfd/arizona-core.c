...
dev_err(dev, "DBG 32 kHz clock: 0x%01x\n", arizona->pdata.clk32k_src);
		regmap_update_bits(arizona->regmap, ARIZONA_CLOCK_32K_1,
	...
	if (ret != 0)
		goto err_reset;
dev_err(dev, "DBG arizona_irq_init complete\n");
...
dev_err(dev, "DBG arizona_request_irq complete - CLKGEN error=%d\n", ARIZONA_IRQ_CLKGEN_ERR);

	arizona_request_irq(arizona, ARIZONA_IRQ_OVERCLOCKED, "Overclocked",
			    arizona_overclocked, arizona);
dev_err(dev, "DBG arizona_request_irq complete - Overclocked=%d\n", ARIZONA_IRQ_OVERCLOCKED);

	arizona_request_irq(arizona, ARIZONA_IRQ_UNDERCLOCKED, "Underclocked",
			    arizona_underclocked, arizona);
dev_err(dev, "DBG arizona_request_irq complete - Underclocked=%d\n", ARIZONA_IRQ_UNDERCLOCKED);
...
dev_err(dev, "DBG arizona core init complete\n");
